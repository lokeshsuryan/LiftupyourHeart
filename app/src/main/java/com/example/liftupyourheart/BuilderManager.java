...
public class BuilderManager {
    ...
    private static int[] imageResources = new int[]{
            R.drawable.prayer_boom,
            R.drawable.img_4,
            R.drawable.answer,
            R.drawable.setting,
            R.drawable.group_boom,
            R.drawable.add_group_boom
    };
    private static int[] textString = new int[]{
            R.string.you_prayer,
            R.string.reminder,
            R.string.answer,
            R.string.setting,
    ...
    private static int textStringIndex = 0;
    ...
    static int getStringResource() {
        if (textStringIndex >= textString.length) textStringIndex = 0;
        return textString[textStringIndex++];
    }
/*
...
/*
   ...
   /* static HamButton.Builder getHamButtonBuilder() {
        return new HamButton.Builder()
                .normalImageRes(getImageResource())
                .normalTextRes(R.string.text_inside_circle_button_text_normal)
                .subNormalTextRes(R.string.text_inside_circle_button_text_normal);
    }
